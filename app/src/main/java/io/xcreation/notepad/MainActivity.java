...
public class MainActivity extends AppCompatActivity {
  ...
  EditText editText1;
  String fileName;
  private static final String DATA_FOLDER_NAME = ".xio";
  ...
  public void onCreate(Bundle bundle) {
    ...
    final String __root__ = Environment
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
      MainActivity.DATA_FOLDER =
        Paths.get(__root__, MainActivity.DATA_FOLDER_NAME, APP_NAME).toString();
      this.fileName = Paths.get(MainActivity.DATA_FOLDER, FILENAME).toString();
    } else {
      MainActivity.DATA_FOLDER =
        __root__ + MainActivity.DATA_FOLDER_NAME + APP_NAME;
  ...
  public void makeToast(String str) {
    Toast
      .makeText(this.getApplicationContext(), str, Toast.LENGTH_SHORT)
      .show();
  }
}
